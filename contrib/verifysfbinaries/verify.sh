...
WORKINGDIR="/tmp/iQcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/iQcoin/iQcoin/iQcoin-0.8.2/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/iQcoin/iQcoin/"
VERSIONPREFIX="iQcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'iQcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[iQcoin-]<version>-[rc[0-9]] (example: iQcoin-0.7.1-rc1)"
   echo "wget output:"
