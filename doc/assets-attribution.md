The following is a list of assets used in the iQcoin source and their proper attribution.
...
* License: MIT
* Site: [https://iQcointalk.org/index.php?topic=15276.0](https://iQcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original iQcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/iQcoin.icns, src/qt/res/src/iQcoin.svg,
	src/qt/res/src/iQcoin.ico, src/qt/res/src/iQcoin.png,
	src/qt/res/src/iQcoin_testnet.png, docs/iQcoin_logo_doxygen.png,
