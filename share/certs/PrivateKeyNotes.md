...
unlocked to sign the iQcoin-Qt.app bundle.
...
allowing somebody to distribute a iQcoin-Qt.app or iQcoin-qt-setup.exe with a valid
...
that the iQcoin-qt.exe file inside the installer had not been tampered with.
