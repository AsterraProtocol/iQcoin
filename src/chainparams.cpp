...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("iQcoin.sipa.be", "seed.iQcoin.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.iQcoin.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("iQcoinstats.com", "seed.iQcoinstats.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("iQcoin.petertodd.org", "testnet-seed.iQcoin.petertodd.org"));
