...
#if defined(NDEBUG)
# error "iQcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "iQcoin Signed Message:\n";
...
string GetWarnings(string strFor)
{
    ...
    if (!CLIENT_VERSION_IS_RELEASE)
        strStatusBar = _("This is a Beta version");
