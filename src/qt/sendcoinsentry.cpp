    ...
    model(0)
{
    ...
    ui->payTo->setPlaceholderText(tr("Enter a iQcoin address (e.g. 1NS17iag9jJgTHD1VXjvLCEnZuQ3rJDE9L)"));
#endif
    setFocusProxy(ui->payTo);

    // normal iQcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying iQcoin address(es)
    ui->payTo_is->setFont(GUIUtil::iQcoinAddressFont());
}
